...
import { LightProbeGenerator } from '../three.js-master/examples/jsm/lights/LightProbeGenerator.js';
...
function init() {
    ...
    const urls = genCubeUrls( '../static/three.js-master/examples/textures/cube/pisa/', '.png' );
